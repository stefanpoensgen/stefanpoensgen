...
- [tinect/TinectRedirects](https://github.com/tinect/TinectRedirects) ([2.1.1](https://github.com/tinect/TinectRedirects/releases/tag/2.1.1), 2 days ago) - 301/302 redirect management plugin for Shopware 6 💙 Just if it would fail into NOT_FOUND
...
- [stefanpoensgen/SptecOrderComments](https://github.com/stefanpoensgen/SptecOrderComments) ([3.0.0](https://github.com/stefanpoensgen/SptecOrderComments/releases/tag/3.0.0), 1 week ago) - Adds the ability to store comments to orders in the Shopware Admin.
- [FriendsOfShopware/FroshPlatformShareBasket](https://github.com/FriendsOfShopware/FroshPlatformShareBasket) ([1.1.7](https://github.com/FriendsOfShopware/FroshPlatformShareBasket/releases/tag/1.1.7), 3 weeks ago) - This plugin allows your customers to save the current basket and share it via link.
