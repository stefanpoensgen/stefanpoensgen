...
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.6.4.1](https://github.com/shopware/shopware/releases/tag/v6.6.4.1), 3 weeks ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 1.500 community extensions
- [tinect/TinectRedirects](https://github.com/tinect/TinectRedirects) ([2.4.0](https://github.com/tinect/TinectRedirects/releases/tag/2.4.0), 4 weeks ago) - 301/302 redirect management plugin for Shopware 6 💙 Just if it would fail into NOT_FOUND
