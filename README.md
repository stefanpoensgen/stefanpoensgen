...
- [tinect/TinectRedirects](https://github.com/tinect/TinectRedirects) ([3.0.0](https://github.com/tinect/TinectRedirects/releases/tag/3.0.0), 3 days ago) - 301/302 redirect management plugin for Shopware 6 💙 Just if it would fail into NOT_FOUND
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.6.10.2](https://github.com/shopware/shopware/releases/tag/v6.6.10.2), 3 days ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 1.500 community extensions
