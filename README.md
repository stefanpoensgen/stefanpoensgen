...
- [tinect/TinectRedirects](https://github.com/tinect/TinectRedirects) ([3.1.6](https://github.com/tinect/TinectRedirects/releases/tag/3.1.6), 5 days ago) - 301/302 redirect management plugin for Shopware 6 💙 Just if it would fail into NOT_FOUND
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.7.4.0](https://github.com/shopware/shopware/releases/tag/v6.7.4.0), 1 week ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 3.100 community extensions
