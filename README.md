...
- [FriendsOfShopware/FroshTools](https://github.com/FriendsOfShopware/FroshTools) ([1.1.0](https://github.com/FriendsOfShopware/FroshTools/releases/tag/1.1.0), 1 day ago) - A collection of useful tools for Shopware 6
- [shopware/platform](https://github.com/shopware/platform) ([v6.5.2.1](https://github.com/shopware/platform/releases/tag/v6.5.2.1), 2 days ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 1.500 community extensions
